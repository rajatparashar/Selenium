...
public class HandleWindowPopUp {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 /*1. alerts - Javascript Pop Up -- Alert API (alert(), dismiss() methods are used)
		 * 2. File Upload Pop Up -- Browse Button (type='file' and sendKeys() method is used)
		 * 3. Browser Window Pop Up -- Advertisement Pop Up(windowHandler API - getWindowHandles() method is used)
		 */
